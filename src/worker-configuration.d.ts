/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 58a42d4e4efe4732aee9a34ea5411e2d)
// Runtime types generated with workerd@1.20251011.0 2025-10-31 nodejs_als
declare namespace Cloudflare {
	...
	interface Env {
		MY_DURABLE_OBJECT: DurableObjectNamespace<import("./worker").MyDurableObject>;
		ASSETS: Fetcher;
	}
}
